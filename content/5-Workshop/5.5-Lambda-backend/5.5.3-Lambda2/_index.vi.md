...
#### 5.5.3. Hàm Lambda 2: WebSocket API (RealtimeChatHandler)
Hàm này là trái tim của hệ thống Real-time. Nó quản lý trạng thái kết nối, lưu tin nhắn vào DynamoDB và phát sóng (broadcast) tin nhắn đến đúng người nhận.
1. Tạo hàm thứ hai tên RealtimeChatHandler bằng Python 3.12 và vẫn sử dụng Role ChatApp_Lambda_Role.
2. Dán mã nguồn Python bên dưới và nhấn Deploy:
